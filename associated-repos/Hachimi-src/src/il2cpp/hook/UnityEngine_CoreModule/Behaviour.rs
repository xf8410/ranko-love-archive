...
static mut STARTCOROUTINE_ADDR: usize = 0;
impl_addr_wrapper_fn!(StartCoroutine, STARTCOROUTINE_ADDR, *mut Il2CppObject, this: *mut Il2CppObject, routine: *mut Il2CppObject);
...
pub fn init(_UnityEngine_CoreModule: *const Il2CppImage) {
    unsafe {
        ...
        STARTCOROUTINE_ADDR = il2cpp_resolve_icall(c"UnityEngine.MonoBehaviour::StartCoroutineManaged2()".as_ptr());
    }
}
